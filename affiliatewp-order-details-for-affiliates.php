 ...
 */
class AffiliateWP_ODFA_Requirements_Check extends AffiliateWP_Requirements_Check_v1_1 {
	 ...
	 * @var   string
	 */
	protected $slug = 'affiliatewp-order-details-for-affiliates';
	...
	public function bootstrap() {
		if ( ! class_exists( 'Affiliate_WP' ) ) {
			...
			\AffiliateWP_Order_Details_For_Affiliates::instance( __FILE__ );
		}
	}
	...
	protected function load() {
		...
		if ( ! class_exists( 'AffiliateWP_Order_Details_For_Affiliates' ) ) {
			require_once dirname( __FILE__ ) . '/includes/class-affiliatewp-order-details-for-affiliates.php';
		}
	...
	public function install() {
		...
		if ( defined( 'AFFWP_ODFA_VERSION' ) ) {
			update_option( 'affwp_odfa_version', AFFWP_ODFA_VERSION );
		}
	}
	...
	protected function unmet_requirements_label() {
		return esc_html__( 'AffiliateWP - Order Details for Affiliates Requirements', 'affiliatewp-order-details-for-affiliates' );
	}
...
$requirements = new AffiliateWP_ODFA_Requirements_Check( __FILE__ );
